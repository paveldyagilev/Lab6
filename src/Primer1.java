...
public class Primer1 {
    public static void main(String[] args) throws IOException {
        ...
        try {
            in = new FileReader("C:\\Users\\6aibal\\Documents\\!Лабы\\3semestre\\AIP\\Lab 6\\MyFile1.txt"); // файл для чтения
            out= new FileWriter("C:\\Users\\6aibal\\Documents\\!Лабы\\3semestre\\AIP\\Lab 6\\MyFile1.txt", true); // файл для записи
